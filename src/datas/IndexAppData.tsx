...
let dataList: Array<IndexAppDataType> = [
    ...
    { destination: '/app/eccLearning ', title: 'ecc', desc: '椭圆曲线加密算法', cover: '/images/椭圆曲线的加法.png' },
    ...
    { destination: '/app/draggingList', title: '列表拖放排序', desc: '列表拖放排序', cover: '/images/椭圆曲线的加法.png' },
]
